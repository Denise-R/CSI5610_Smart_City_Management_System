...
class Task(NamedTuple):
    ...
    def to_dict(self) -> Dict:
        return {"department": self.department, "responsible": self.responsible, "time_est": self.time_est, "description": self.description, "uid": self.uid}
...
class Ui_TaskSchedulerWindow(object):
    ...
    def setupUi(self, TaskSchedulerWindow):
        ...
        TaskSchedulerWindow.resize(800, 600)
        ...
        self.statusbar = QtWidgets.QStatusBar(TaskSchedulerWindow)
        self.statusbar.setObjectName("statusbar")
        TaskSchedulerWindow.setStatusBar(self.statusbar)
